...
import ScrollToTop from '../../helpers/scroll.js';
...
export default class Blog extends Component {
  ...
  render() {
    ...
    return (
      <Router>
        <ScrollToTop>
          <BlogNav isLoggedIn={isLoggedIn} logInFormOpen={this.logInFormOpen} />

          <Switch>
            <Route
              exact
              path="/blog-byNersisyan"
              component={(props) => (
                <Posts
                  {...props}
            ...
            />
            <ProtectedRoute
              path="/blog-byNersisyan/blog/create"
              isLoggedIn={isLoggedIn}
            ...
            />
            <ProtectedRoute
              path={`/blog-byNersisyan/post/:postId`}
              isLoggedIn={isLoggedIn}
              component={PostPage}
              posts={posts}
              users={users}
